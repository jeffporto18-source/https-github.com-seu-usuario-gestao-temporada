...
import { LayoutDashboard, LogOut, PanelLeft, Users, Building2, Receipt, BookOpen, CalendarDays, FileText, BarChart3, Upload, UserCog, UsersRound, Landmark, UserCog2, FileSignature, Package, Wallet, TrendingUp, Truck, PieChart, ClipboardList } from "lucide-react";
...
const allMenuItems = [
  ...
  { icon: ClipboardList, label: "Relatórios para Contabilidade", path: "/relatorios-contabilidade", hideFor: [] as string[] },
